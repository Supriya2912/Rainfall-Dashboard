...
app.layout = html.Div([
    ...
    style={'text-align': 'left','font-size':'20px'},
            ...
            html.Div([
                html.Img(src='https://png.pngtree.com/thumb_back/fh260/background/20211118/pngtree-technology-round-dashboard-image_908915.jpg', style={'width': '90%','background-position': 'center'}),
